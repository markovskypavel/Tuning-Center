...
public class GetServiceFormCommand extends CommandDecorator {

    public GetServiceFormCommand(Command refreshCommand) {
    ...
    public Router execute(HttpServletRequest req, HttpServletResponse res) {
        ...
        httpSession.setAttribute(AttributeParameters.SERVICE_FORM, UtilConstant.STUB);
        return router;
    }
