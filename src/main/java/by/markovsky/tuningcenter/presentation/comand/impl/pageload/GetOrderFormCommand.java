...
public class GetOrderFormCommand extends CommandDecorator {

    public GetOrderFormCommand(Command refreshCommand) {
    ...
    public Router execute(HttpServletRequest req, HttpServletResponse res) {
        ...
        httpSession.setAttribute(AttributeParameters.ORDER_FORM, UtilConstant.STUB);
        return router;
    }
